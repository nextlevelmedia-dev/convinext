...
<div className="border-y border-slate-200 dark:border-slate-800 bg-white/80 dark:bg-transparent backdrop-blur-sm py-8 px-6">
  <div className="mx-auto max-w-7xl flex flex-col-reverse md:flex-row items-center gap-6 md:gap-0">
    ...
    <div className="flex items-center gap-3 md:pr-8 md:border-r border-slate-200 dark:border-slate-700 shrink-0 w-full md:w-auto justify-center md:justify-start">
      ...
      <div>
        ...
        <p className="text-[11px] font-semibold text-slate-500 dark:text-slate-400">Results Certified</p>
      </div>
    </div>

    {/* STATISTICHE */}
    <div className="grid grid-cols-3 md:grid-cols-4 gap-0 w-full md:pl-8 divide-x divide-slate-200 dark:divide-slate-700">
      {[
