...
export default function ProjectCarousel() {
  useEffect(() => {
    ...
    const coverflow = document.querySelector<HTMLElement>('.nlm-coverflow')

    if (!slides.length || !track || !coverflow) return
    ...
    function params() {
      ...
      const desktop = { x1: 260, x2: 480, s1: 0.85, s2: 0.7 }

      if (w <= minW) return mobile
      if (w >= maxW) return desktop

      const t = (w - minW) / (maxW - minW)

      return {
        x1: lerp(mobile.x1, desktop.x1, t),
        x2: lerp(mobile.x2, desktop.x2, t),
        s1: lerp(mobile.s1, desktop.s1, t),
        s2: lerp(mobile.s2, desktop.s2, t),
      }
    }
    ...
    function render() {
      ...
      slides.forEach((slide, i) => {
        ...
        slide.style.transition = 'transform 0.9s cubic-bezier(0.25,1,0.3,1)'
  ...
  return (
    <section className="nlm-coverflow">
      <button className="nlm-btn prev" aria-label="Previous">
        &#10094;
      </button>

      <div className="nlm-track">
        <div className="nlm-slide">
          <div className="nlm-card">
            <img src="https://next-level-media.it/wp-content/uploads/2025/12/Progetto-senza-titolo-2025-12-05T160336.097-2.webp" alt="Dance On - sito web" width="600" height="400" />
            <h3>Dance On</h3>
            <h4>SITO WEB - CUSTOM DEVELOPMENT - SEO</h4>
        ...
        <div className="nlm-slide">
          <div className="nlm-card">
            <img src="https://staging2.next-level-media.it/wp-content/uploads/2025/12/Progetto-senza-titolo-2025-12-05T160843.763-1.webp" alt="Need JPG - ecommerce" width="600" height="400" />
            <h3>Need Jpg</h3>
            <h4>E-COMMERCE - CUSTOM DEVELOPMENT - ADV</h4>
        ...
        <div className="nlm-slide">
          <div className="nlm-card">
            ...
            <h3>Snakes Milano</h3>
            <h4>LANDING - CUSTOM DEVELOPMENT - DONAZIONI</h4>
        ...
        <div className="nlm-slide">
          <div className="nlm-card">
            ...
            <h3>Barlafus Cafè</h3>
            <h4>SITO WEB - CUSTOM DEVELOPMENT</h4>
        ...
        <div className="nlm-slide">
          <div className="nlm-card">
            <img src="https://staging2.next-level-media.it/wp-content/uploads/2025/12/Progetto-senza-titolo-2025-12-05T123451.217-1.webp" alt="Vitera Group - sito web" width="600" height="400" />
            <h3>Vitera Group</h3>
            <h4>SITO WEB - CUSTOM DEVELOPMENT</h4>
        ...
        <div className="nlm-slide">
          <div className="nlm-card">
            <img src="https://staging2.next-level-media.it/wp-content/uploads/2025/12/Progetto-senza-titolo-2025-12-05T123338.051-1.webp" alt="Davide Fratta - landing page" width="600" height="400" />
            <h3>Davide Fratta</h3>
            <h4>LANDING PAGE - CUSTOM DEVELOPMENT</h4>
        ...
        <div className="nlm-slide">
          <div className="nlm-card">
            <img src="https://staging2.next-level-media.it/wp-content/uploads/2025/12/Progetto-senza-titolo-2025-12-05T155229.614-1.webp" alt="Samgroup Srl - portfolio" width="600" height="400" />
            <h3>Samgroup Srl</h3>
            <h4>SITO WEB - PORTFOLIO</h4>
        ...
        <div className="nlm-slide">
          <div className="nlm-card">
            <img src="https://staging2.next-level-media.it/wp-content/uploads/2025/12/Progetto-senza-titolo-2025-12-05T155432.570-1.webp" alt="Animali Rho - donazioni" width="600" height="400" />
            <h3>Animali Rho</h3>
            <h4>SITO WEB - DONAZIONI</h4>
      ...
      <button className="nlm-btn next" aria-label="Next">
        &#10095;
      </button>
    </section>
  )
