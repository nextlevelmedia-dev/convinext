...
interface ProcessEcommerceProps {
...
export default function ProcessEcommerce({
  titleHighlight,
  titleNormal,
  subtitle,
  steps,
}: ProcessEcommerceProps) {
  ...
  #nlm-web-process-timeline .timeline::before,
  #nlm-web-process-timeline .timeline__progress,
  #nlm-web-process-timeline .timeline__tracker,
  #nlm-web-process-timeline .step__middle{
    display:none;
  }

  #nlm-web-process-timeline .step{
  ...
  #nlm-web-process-timeline .step__left,
  #nlm-web-process-timeline .step__right{
    grid-column:auto;
    justify-content:flex-start!important;
  }

  #nlm-web-process-timeline .card,
  #nlm-web-process-timeline .graphic{
    max-width:100%;
    width:100%;
  }

  #nlm-web-process-timeline .step[data-side="right"] .step__right{
    order:1;
  }

  #nlm-web-process-timeline .step[data-side="right"] .step__left{
    order:2;
  }
}
          `}</style>
                ...
                <div className="graphic">
                  <div className="graphic__pad">
                    <div className="nx-map__stage">
                      <div className="nx-node nx-node--a"><div className="nx-node__chip">Obiettivi</div><div className="nx-node__text">Vendite, ordini e crescita dello store.</div></div>
                      <div className="nx-node nx-node--b"><div className="nx-node__chip">Target</div><div className="nx-node__text">A chi stai vendendo davvero.</div></div>
                      <div className="nx-node nx-node--c"><div className="nx-node__chip">Catalogo</div><div className="nx-node__text">Prodotti, varianti e priorità.</div></div>
                      <div className="nx-node nx-node--d"><div className="nx-node__chip nx-node__chip--primary">Strategia store</div><div className="nx-node__text">Percorso d'acquisto e conversione.</div></div>
                      ...
                      <div className="nx2-sitemap__canvas">
                        <ul className="nx2-tree">
                          <li className="nx2-tree__root">
                            <div className="nx2-node nx2-node--root">Store</div>
                            <ul className="nx2-tree__level nx2-tree__level--top">
                              <li className="nx2-tree__branch">
                                <div className="nx2-node nx2-node--top">Catalogo</div>
                                <ul className="nx2-tree__level nx2-tree__level--leaf">
                                  <li><div className="nx2-node nx2-node--leaf">Categorie</div></li>
                                  <li><div className="nx2-node nx2-node--leaf">Filtri</div></li>
                                </ul>
                              </li>
                              <li className="nx2-tree__branch"><div className="nx2-node nx2-node--top">Prodotto</div></li>
                              <li className="nx2-tree__branch">
                                <div className="nx2-node nx2-node--top">Checkout</div>
                                <ul className="nx2-tree__level nx2-tree__level--leaf">
                                  <li><div className="nx2-node nx2-node--leaf">Pagamento</div></li>
                                  <li><div className="nx2-node nx2-node--leaf">Spedizione</div></li>
                                  <li><div className="nx2-node nx2-node--leaf">Conferma</div></li>
                                </ul>
                              </li>
                              <li className="nx2-tree__branch">
                                <div className="nx2-node nx2-node--top">Account</div>
                                <ul className="nx2-tree__level nx2-tree__level--leaf">
                                  <li><div className="nx2-node nx2-node--leaf">Ordini</div></li>
                                  <li><div className="nx2-node nx2-node--leaf">Wishlist</div></li>
                                  <li><div className="nx2-node nx2-node--leaf">Profilo</div></li>
                                </ul>
                              </li>
                            </ul>
                          </li>
                      ...
                      <div className="nx3-device" data-nx3-device>
                        <div className="nx3-device__top">
                          ...
                          <div className="nx3-url">
                            ...
                            <span className="nx3-url__text">preview.yourstore.it</span>
                          </div>
                        ...
                        <div className="nx3-device__badge">
                          <span className="nx3-badge-dot"></span> Store preview
                        </div>
                      </div>
                    </div>
                  </div>
